...
<body class="bg-gray-50 min-h-screen p-4 md:p-8">
  ...
  <div class="bg-white shadow-2xl rounded-3xl p-6 md:p-10 w-full max-w-4xl mx-auto">
    ...
    <form method="POST" action="/Stock%20Progressive/contact.php?" class="grid grid-cols-1 md:grid-cols-2 gap-6">
...
<!--  -->
      ...
      <div class="form-control w-full">
        ...
        <input type="number" name="mobileEdit" id="mobileEdit" value="<?php echo $row['mobile']; ?>" placeholder="mobile" class="input input-bordered w-full bg-white">
      </div>
